...
class SFW(Plugin):
    ...
    async def asian(self, ctx):
        async with ctx.typing():
            async with self.bot.session.get("http://149.202.62.19/api/asians", headers=FLOWER_HEADERS) as r:
                file = await r.read()
                file_data = r.headers
                file_name = "\U0001f609"
...
class NSFW(Plugin):
    ...
    async def toocute(self, ctx):
        async with ctx.typing():
            async with self.bot.session.get("http://149.202.62.19/api/nsfw/toocute", headers=FLOWER_HEADERS) as r:
                file = await r.read()
                file_data = r.headers
                file_name = "\U0001f609"
    ...
    async def public(self, ctx):
        async with ctx.typing():
            async with self.bot.session.get("http://149.202.62.19/api/nsfw/public", headers=FLOWER_HEADERS) as r:
                file = await r.read()
                file_data = r.headers
                file_name = "\U0001f609"
    ...
    async def ass(self, ctx):
        async with ctx.typing():
            async with self.bot.session.get("http://149.202.62.19/api/nsfw/ass", headers=FLOWER_HEADERS) as r:
                file = await r.read()
                file_data = r.headers
                file_name = "\U0001f609"
    ...
    async def boobs(self, ctx):
        async with ctx.typing():
            async with self.bot.session.get("http://149.202.62.19/api/nsfw/boobs", headers=FLOWER_HEADERS) as r:
                file = await r.read()
                file_data = r.headers
                file_name = "\U0001f609"
