...
class Logs(Plugin):
    ...
    async def on_bulk_message_delete(self, m):
        ...
        e = discord.Embed(description=lang['bulk_message_deleted'].format(len(m) - 1, m[0].channel.mention),
                          color=0x6e100a,
    ...
    async def on_mod_command_use(self, ctx):
        ...
        e = discord.Embed(description=ctx.lang['used_command'].format(ctx.author.mention, ctx.command.name),
